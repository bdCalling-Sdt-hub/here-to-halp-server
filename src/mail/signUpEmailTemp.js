const signUpEmailTemp = (data) => `
  <html>
    ...
    <body>
      <div class="container">
        <h1>Welcome to HereToHalp</h1>
        <p>Hello, ${data.user}</p>
        <p>Thank you for registering with HereToHalp. To activate your account, please use the following activation code:</p>
        ...
        <p>Thank you,<br>The HereToHalp Team</p>
      </div>
      <div class="footer">
        <p>&copy; HereToHalp - All Rights Reserved.</p>
